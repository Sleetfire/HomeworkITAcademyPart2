...
public class UserEntity {
    ...
    private UserEntity(Long id, String login, String password, String name, LocalDate rgDate, LocalDate birthday, LocalDateTime updateDateTime) {
        this.id = id;
        this.login = login;
    ...
    public static class Builder {
        ...
        public UserEntity build() {
            return new UserEntity(this.id, this.login, this.password, this.name, this.rgDate, this.birthday, this.updateDateTime);
        }
    }
}
